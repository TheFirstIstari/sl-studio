<script lang="ts">
  ...
  function getCategoryIcon(category: string | null): string {
    switch (category) {
      case 'Financial': return 'dollar';
      case 'Legal': return 'scale';
      case 'Digital': return 'laptop';
      case 'Physical': return 'map-pin';
      case 'Verbal': return 'mic';
      default: return 'file';
    }
  }
      ...
      {#if selectedFact}
        <div class="fact-detail">
          ...
          <div class="detail-row">
            ...
            <span class="detail-value crime">{selectedFact.identified_crime || 'None identified'}</span>
          </div>
