<script lang="ts">
  ...
  const RECOMMENDED_MODELS = [
    { id: "TheBloke/Mistral-7B-Instruct-v0.2-GGUF", name: "Mistral 7B Instruct", size: "~4.1GB", quantization: "Q4_K_M" },
    { id: "TheBloke/Llama-2-7B-Chat-GGUF", name: "Llama 2 7B Chat", size: "~3.8GB", quantization: "Q4_K_M" },
    { id: "TheBloke/Qwen-2.5-7B-Instruct-GGUF", name: "Qwen 2.5 7B Instruct", size: "~4.7GB", quantization: "Q4_K_M" },
    { id: "TheBloke/Mixtral-8x7B-Instruct-v0.1-GGUF", name: "Mixtral 8x7B", size: "~26GB", quantization: "Q4_K_M" },
  ];
